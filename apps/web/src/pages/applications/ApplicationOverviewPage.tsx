...
export function ApplicationOverviewPage() {
  ...
  return (
    <>
      ...
      {canManageLifecycle(workspace.role) ? <LifecyclePanel entityType="application" entityName={application.name} entityId={application.id} returnTo="/applications" /> : null}
    </>
  );
}
