...
export function NewApplicationPage() {
  ...
  if (!canWriteWorkspace(workspace.role)) {
    return (
      <>
        <PageHeader eyebrow="Applications" title="Add application" />
        <div className="error-panel" role="alert">
          <div>
            <strong>Read-only workspace</strong>
            <span>Your workspace role cannot create applications.</span>
          </div>
        </div>
      </>
    );
  ...
  return (
    <>
      <PageHeader
        ...
        description="Create a product container. Targets and tests remain scoped to this application."
      />
      <form className="panel form-grid form-card" onSubmit={submit}>
        ...
        <input
          ...
          autoFocus
        />
        <label className="field-label" htmlFor="app-description">
        ...
        <textarea
          ...
          placeholder="What product or product area will your team evaluate?"
          rows={4}
        />
        {error ? (
