...
export function RunLayout() {
  ...
  const runQuery = useQuery({
    ...
    refetchInterval: query => query.state.data && !terminalTestStatuses.has(query.state.data.status) ? 5_000 : false,
  });
