...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "idle_expires_at <= absolute_expires_at", name="ck_user_sessions_expiration_order"
        ),
        sa.ForeignKeyConstraint(
            ["identity_id"],
            ["auth.user_identities.id"],
            name=op.f("fk_user_sessions_identity_id_user_identities"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["user_id"],
    ...
    op.create_index(
        op.f("ix_user_sessions_identity_id"),
        "user_sessions",
        ["identity_id"],
        unique=False,
        schema="auth",
    ...
    op.create_index(
        op.f("ix_user_sessions_user_id"), "user_sessions", ["user_id"], unique=False, schema="auth"
    )
    op.create_table(
        "workspace_members",
...
def downgrade() -> None:
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(
        op.f("ix_workspace_members_user_id"), table_name="workspace_members", schema="core"
    )
